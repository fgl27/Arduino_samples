...
/*!
 ...
 The time is expressed in micro-seconds. 37 is default
 */
#define EXEC_TIME 37

class LiquidCrystalDue : public LCD
{
public:
   /*!
    @method     
    ...
    */
   LiquidCrystalDue(uint8_t rs, uint8_t enable,
                 uint8_t d0, uint8_t d1, uint8_t d2, uint8_t d3,
                 uint8_t d4, uint8_t d5, uint8_t d6, uint8_t d7);
   LiquidCrystalDue(uint8_t rs, uint8_t rw, uint8_t enable,
                 uint8_t d0, uint8_t d1, uint8_t d2, uint8_t d3,
                 uint8_t d4, uint8_t d5, uint8_t d6, uint8_t d7);
...
private:
   ...
   /*!
    @method     
    @abstract   Fast digitalwrite for Arduino DUE
    @discussion Uses port manipulation to set pin high or low
    */ 
